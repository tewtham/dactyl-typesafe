...
#define DOWN_LAYER 0x05 // pop layer
#define UP_LAYER 0x06 // push layer
#define UNUSED 0x07
#define TRANSP 0x08 // transparent
...
Key transp = Key(TRANSP);
Key layerU = Key(UP_LAYER);
Key layerD = Key(DOWN_LAYER);
